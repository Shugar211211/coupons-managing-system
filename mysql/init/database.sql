...
--
-- Host: localhost    Database: jb_coupons_3
-- ------------------------------------------------------
...
CREATE TABLE `customers_vs_coupons` (
  ...
  KEY `FKqic70ugf37j3rc4og2t3xp0ah` (`coupon_id`),
  KEY `FK9eo7wdxttf4eivll1gr5xacgk` (`customer_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-05-15 13:42:15
