package com.jb.coupons_project.auth.filters;
...
@Component
@Order(3)
public class CompanyAuthorizationFilter extends OncePerRequestFilter{
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if( ! role.equalsIgnoreCase(ClientType.COMPANY.getClientType()) ) {
...
//		if(path.equals("/authenticate") || path.startsWith("/admin") || path.startsWith("/customer"))
//			return true;
//		else
//			return false;
//	}
